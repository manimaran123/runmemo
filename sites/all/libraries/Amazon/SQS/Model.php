...
/**
 * Amazon_SQS_Model - base class for all model classes
 */ 
abstract class Amazon_SQS_Model
{
            ...
            if (is_array($fieldType)) {
                if ($this->_isComplexType($fieldType[0])) {
                    ...
                    if ($elements->length >= 1) {
                        require_once (DRUPAL_ROOT . '/sites/all/libraries/'.str_replace('_', DIRECTORY_SEPARATOR, $fieldType[0]) . ".php");
                ...
                if ($this->_isComplexType($fieldType)) {
                    $elements = $xpath->query("./a:$fieldName", $dom);
                    if ($elements->length == 1) {
                        require_once DRUPAL_ROOT . '/sites/all/libraries/'.(str_replace('_', DIRECTORY_SEPARATOR, $fieldType) . ".php");
    ...
    {
        return preg_match('/^Amazon_SQS_Model_/', $fieldType);
    }
