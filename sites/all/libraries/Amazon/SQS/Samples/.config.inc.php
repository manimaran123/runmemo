<?php
    ...
    ***********************************************************************/
    ...
    define('AWS_ACCESS_KEY_ID', 'AKIAIRTJUKYUZ5WXVZQA');
    define('AWS_SECRET_ACCESS_KEY','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');  
    ...
    ***********************************************************************/   
     function __autoload($className){
        ...
        $filePath = DRUPAL_ROOT . '/sites/all/libraries/Amazon/SQS/'.str_replace('_', DIRECTORY_SEPARATOR, $className) . '.php';
